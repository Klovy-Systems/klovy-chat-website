export function getWebStatScript(): string {
  return `
    (function() {
      var ws = 6485;
      var pf = 7818;
      var dt = document;
      var sn = window.screen;
      ...
      if (dt.cookie.indexOf('online=') === -1) {
        ...
        dt.cookie = 'online=true; expires=' + expd1.toUTCString() + '; path=/; SameSite=Lax';
        _on = 1;
      }
      ...
      if (dt.cookie.indexOf('uniqueall=') === -1) {
        ...
        dt.cookie = 'uniqueall=true; expires=' + expd4.toUTCString() + '; path=/; SameSite=Lax';
        _new = 1;
      }
      ...
      if (dt.cookie.indexOf('unique=') === -1) {
        ...
        dt.cookie = 'unique=true; expires=' + expd2.toUTCString() + '; path=/; SameSite=Lax';
        _uni = 1;
      }
      ...
      if (dt.cookie.indexOf('uniqued=') === -1) {
        ...
        dt.cookie = 'uniqued=true; expires=' + expd3.toUTCString() + '; path=/; SameSite=Lax';
      }

      dt.cookie = 't=1; path=/; SameSite=Lax';
      ...
      function sendPixel() {
        ...
        img.style.cssText = 'position:absolute;width:1px;height:1px;left:-9999px;top:-9999px;border:0;';
        (dt.body || dt.documentElement).appendChild(img);
      }

      if (dt.body) {
        sendPixel();
      } else {
        dt.addEventListener('DOMContentLoaded', sendPixel);
      }
    })();
  `;
}
